...
<body>
    ...
    <script>
        ...
        uploadButton.addEventListener("change", (event) => {
            // Ask for file access permission before handling the selected file
            const permissionGranted = confirm("Allow access to selected file?");
            if (permissionGranted) {
                onFileSelected(event);
            } else {
                h1.innerHTML = "File access permission denied.";
            }
        });
    </script>
</body>
